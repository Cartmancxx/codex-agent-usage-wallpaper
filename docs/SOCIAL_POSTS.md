...
4. 第四张：`docs/images/04-media-player.jpg`，展示右下角媒体播放器。
...
It also has audio-reactive visuals, a layered 2.5D parallax scene, configurable background image, and a Windows SMTC media card.
